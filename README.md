...
⚠️ Passe como parâmetro, para o seu gráfico, uma matriz com CFPoints. Nesse primeiro exemplo temos apenas um dado na matriz, já que estamos analisando apenas um dado <br>
